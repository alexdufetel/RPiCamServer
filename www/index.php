...
<html>
   ...
   <body onload="onBodyLoad(); setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      ...
      <div class="container-fluid text-center liveimage">
         <div><img id="mjpeg_dest" <?php echo getLoadClass() . getImgWidth();?> <?php if(file_exists("pipan_on")) echo "ontouchstart=\"pipan_start()\""; ?> onclick="" src="./loading.jpg"></div>
